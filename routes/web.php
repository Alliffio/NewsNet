...
Route::get('/dashboard', 'BlogController@index')->name('blogs.home');
...
// Route::post('/komentar/{id}','PostCommentController@store')->name('blog.komentar');
...
Route::group(['middleware' => 'auth'], function(){
    ...
    Route::get('/logout','LoginController@logout')->name('logoutss');
